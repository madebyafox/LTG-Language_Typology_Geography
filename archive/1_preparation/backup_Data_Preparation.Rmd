...
Each observation (cell) in these datasets represent the mean a month of observations conducted since Jan 1949 ~ Oct 2020
Columns for both datasets are bins of Longitude, and rows are  (degree_north). Temperature values are in Kelvin, and Humidity in %humidity. 
