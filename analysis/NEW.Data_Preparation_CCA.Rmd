...
* `$2018`: GDP in the year 2017 (the most recent year this database provided data for) by country in USD.
...
#how to get to continent?  
gdp.plot<- df_gdp %>% 
  ggplot(aes(x=Country, fill=Country, color=Country, y='2018'))+
