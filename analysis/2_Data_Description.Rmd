...
load(file="../clean-data/by_country_language.RData")
```
...
# PART 4 | Merge  Environmental Data

Finally, we prepare a master dataframe that includes language, country, and environmental data. 
