...
speakers <- by_language %>% select(wals_code, ISO639.3, name, population) #get speaker data

ggplot(data = speakers, aes(x=population)) +
  geom_histogram()+
  labs(title="Distribution of Language by Number of Speakers", 
