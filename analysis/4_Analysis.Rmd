...
```{r}
ejectives.full.model <- lmer(data = final.data, glot_features_new ~ elev_binary + mean_hum + mean_temp + latitude_abs + diversity.new + (1 | stock))

ejectives.reduced.model <- lmer(data = final.data, glot_features_new ~ mean_hum + mean_temp + latitude_abs + diversity.new + (1 | stock))
...
```{r}
tone.full.model <- lmer(data = final.data, tone_num ~ elev_binary + mean_hum + mean_temp + latitude_abs + diversity.new + (1 | stock))

tone.reduced.model <- lmer(data = final.data, tone_num ~ elev_binary + mean_temp + latitude_abs + diversity.new + (1 | stock))
