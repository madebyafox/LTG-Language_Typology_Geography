...
```{r merge countries }
#AMY TAKE ANOTHER LOOK **TODO** manually reconcile full-join mimatches 
...
df_geolocation <- merge(df_hum.long, df_temp.long %>% select(-Longitude.180), by.x=c("Latitude", "Longitude.360"),by.y=c("Latitude", "Longitude.360"))
...
```{r}
#**TODO :: It seems we lost 20 or so rows in the transition somehow - due to spelling differences?** //Maho is manually reconciling these 
